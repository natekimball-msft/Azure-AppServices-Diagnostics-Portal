...
[ArmResourceFilter(provider: "Microsoft.AzurePlaywrightService", resourceTypeName: "accounts")]
...
public async static Task<Response> Run(DataProviders dp, OperationContext<ArmResource> cxt, Response res)
{
    ...
    {
        Table = await dp.Kusto.ExecuteClusterQuery(GetQuery(cxt), "KUSTO_CLUSTER_NAME", "KUSTO_DB_NAME", null, "QueryNameWithoutSpacesCamelCase"),
