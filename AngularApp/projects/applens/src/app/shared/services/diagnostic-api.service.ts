...
export class DiagnosticApiService {
  ...
  public caseNumberNeededEvent: EventEmitter<boolean> =
  ...
  public setCustomerCaseNumber(value) {
    this.CustomerCaseNumber = value;
  }
  ...
  public getDetector(
    ...
    return this.invoke<DetectorResponse>(
      path,
      HttpMethod.POST,
      body,
      true,
  ...
  public getSystemInvoker(
    resourceId: string,
    detector: string,
    systemInvokerId: string = '',
    dataSource: string,
    timeRange: string,
    body?: any
  ): Observable<DetectorResponse> {
    let invokerParameters = this._getSystemInvokerParameters(
      dataSource,
      timeRange
    );
  ...
  ): Observable<DetectorMetaData[]> {
    let path = `${version}${resourceId}/detectors`;
    if (queryParams) {
      path =
        path + '?' + queryParams.map((qp) => qp.key + '=' + qp.value).join('&');
    }
    return this.invoke<DetectorResponse[]>(
      path,
      HttpMethod.POST,
      ...
      retry(1),
      map((response) => response.map((detector) => detector.metadata))
    );
  }

  public getDetectorsWithExtendDefinition(
    version: string,
    resourceId: string,
    body?: any,
    internalClient: boolean = true
  ): Observable<ExtendDetectorMetaData[]> {
    // let path = `${version}${resourceId}/detectorsWithExtendDefinition`;
    let path = `${version}${resourceId}/internal/detectors`;
    return this.invoke<ExtendDetectorMetaData[]>(
      path,
      HttpMethod.POST,
      body,
      true,
  ...
  public getUserPhoto(
    ...
    return useCache
      ? this._cacheService.get(
          this.getCacheKey(HttpMethod.POST, url),
          request,
          invalidateCache
        )
      : request;
  ...
  public getUsers(
    ...
    return useCache
      ? this._cacheService.get(
          this.getCacheKey(HttpMethod.POST, url + body.toString()),
          request,
          invalidateCache
        )
      : request;
  ...
  public getKustoClusterForGeoRegion(
    geoRegion: string,
    useCache: boolean = true,
    invalidateCache: boolean = false
  ): Observable<any> {
  ...
  public getSupportTopics(
    ...
    return useCache
      ? this._cacheService.get(
          this.getCacheKey(HttpMethod.GET, url),
          request,
          invalidateCache
        )
      : request;
  ...
  public getGists(
    ...
    return this.invoke<DetectorResponse[]>(path, HttpMethod.POST, body).pipe(
      retry(1),
      map((response) => response.map((gist) => gist.metadata))
    );
  }

  public getCompilerResponse(
    version: string,
    resourceId: string,
    body: any,
    startTime?: string,
    ...
    return this._getCompilerResponseInternal(
      path,
      body,
      additionalParams,
  ...
  public getSystemCompilerResponse(
    resourceId: string,
    body: any,
    detectorId: string = '',
    dataSource: string = '',
  ...
  public getLocalDevelopmentResponse(
    detectorId: string,
    version: string,
    resourceId: string,
    body: any,
    ...
    return this._cacheService.get(
      this.getCacheKey(method, path),
      request,
      true
    );
  }

  public verfifyPublishingDetectorAccess(
    resourceType: string,
    detectorCode: string,
    isOriginalCodeMarkedPublic: boolean
  ): Observable<any> {
  ...
  public publishPackage(
    ...
    var modifiedByAlias = this._adalService.userInfo.profile
  ...
  public createOrUpdateKustoMappings(
    resourceId: string,
    body: string
  ): Observable<any> {
  ...
  public invoke<T>(
    ...
    if (
      !additionalHeaders.has('x-ms-request-id') ||
      additionalHeaders.get('x-ms-request-id') == null ||
      additionalHeaders.get('x-ms-request-id') == ''
    ) {
      additionalHeaders.set('x-ms-request-id', requestId);
    }

    if (this.CustomerCaseNumber)
      additionalHeaders.set(
        'x-ms-customer-casenumber',
        this.CustomerCaseNumber
      );
    ...
    if (useCache) {
      return this._cacheService.get(
        this.getCacheKey(method, path + keyPostfix),
        request,
        invalidateCache,
        logData
      );
      ...
      this._telemetryService.logEvent(
        logData.eventIdentifier,
        logData.eventPayload
      );
      return request;
    }
  }
  ...
  private _getSystemInvokerParameters(
  ...
  private _getCompilerResponseInternal(
    path: string,
    body: any,
    additionalParams?: any,
    publishingDetectorId: string = ''
    ...
    if (additionalParams && additionalParams.assemblyName) {
      additionalHeaders = additionalHeaders.set(
        'diag-assembly-name',
        encodeURI(additionalParams.assemblyName)
      );
    }

    additionalHeaders = additionalHeaders.set(
      'diag-publishing-detector-id',
      publishingDetectorId
    );

    return this.invoke<QueryResponse<DetectorResponse>>(
      path,
      HttpMethod.POST,
      body,
      false,
      ...
      undefined,
      undefined,
      additionalParams.getFullResponse,
      additionalHeaders
    );
  }
  ...
  updateUserPanelSetting(
    panelSetting: UserPanelSetting,
    userId: string
  ): Observable<UserSetting> {
  ...
  addFavoriteDetector(
    detectorId: string,
    detectorProp: FavoriteDetectorProp,
    userId: string
  ): Observable<UserSetting> {
    const url = `${this.diagnosticApi}api/usersetting/${userId}/favoriteDetectors/${detectorId}`;
  ...
  public getDetectorCode(
    ...
    let path =
      branch === null
        ? `devops/getCode?filePathInRepo=${detectorPath}&resourceUri=${resourceUri}`
        : `devops/getCode?filePathInRepo=${detectorPath}&branch=${branch}&resourceUri=${resourceUri}`;
    return this.invoke(path, HttpMethod.GET, null, false);
  }

  public getDevOpsTree(
    devOpsPath: string,
    branch: string,
    resourceUri: string
  ): Observable<any> {
    let path =
      branch === null
        ? `devops/getTree?filePathInRepo=${devOpsPath}&resourceUri=${resourceUri}`
        : `devops/getTree?filePathInRepo=${devOpsPath}&branch=${branch}&resourceUri=${resourceUri}`;
    return this.invoke(path, HttpMethod.GET, null, false);
  }

  public pushDetectorChanges(
    branch: string,
    files: string[],
    repoPaths: string[],
    comment: string,
  ...
  public getBranches(
    resourceId: string
  ): Observable<{ branchName: string; isMainBranch: string }[]> {
  ...
  public getEnableDetectorDevelopment(): Observable<boolean> {
    ...
    return this.get<boolean>(path).pipe(
      map((res) => {
  ...
  public getDetectorDevelopmentEnv(): Observable<string> {
    ...
    return this.get(path, true).pipe(
      map((res: string) => {
        return res;
      })
    );
