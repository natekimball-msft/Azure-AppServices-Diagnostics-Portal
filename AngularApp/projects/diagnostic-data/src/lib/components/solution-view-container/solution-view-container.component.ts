...
export class SolutionViewContainerComponent implements OnInit {
  ...
  solutionTitleImageSrc: string =
    '../../../../assets/img/case-submission-flow/Help-and-Support.svg';
  ...
  private getIconImagePath() {
    let publicImagePath = this.isRecommended
      ? '../../../../assets/img/case-submission-flow/Help-and-Support.svg'
      : '../../../../assets/img/case-submission-flow/Troubleshoot.svg';
    let internalImagePath = this.isRecommended
      ? 'assets/img/Help-and-Support.svg'
      : 'assets/img/Troubleshoot.svg';
  ...
  onCalloutSubmit() {
    ...
    const feedbackEventProps = {
      ...
      ...(this.askReasonNotHelpful && this.noSelected
        ? { NotHelpfulReason: this.selectedCalloutOption.text }
        : {})
    };
