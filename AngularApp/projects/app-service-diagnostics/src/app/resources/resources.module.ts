...
const ResourceRoutes = RouterModule.forChild([
  // Web Apps
  {
    ...
    loadChildren: () =>
      import('./web-sites/web-sites.module').then((m) => m.WebSitesModule)
  },
  {
  ...
  // App Service Environment
  {
    ...
    loadChildren: () =>
      import('./web-hosting-environments/web-hosting-environments.module').then(
        (m) => m.WebHostingEnvironmentsModule
      )
  },
  ...
  // Generic ARM Resource
  {
    ...
    loadChildren: () =>
      import('./generic-arm-resources/generic-arm-resources.module').then(
        (m) => m.GenericArmResourcesModule
      )
  },
...
@NgModule({
  imports: [CommonModule, ResourceRoutes],
  declarations: [],
  providers: []
})
