...
@Injectable()
export class MetricsPerInstanceAppsResolver
  implements Resolve<Observable<boolean>>
{
  ...
  constructor(
    ...
    this._authService
      .getStartupInfo()
      .subscribe((startupInfo) => (this.resourceId = startupInfo.resourceId));
  }
  resolve(
    ...
    const url =
      this._router.url === '/resourceRedirect'
        ? `resource${this.resourceId}/categories/DiagnosticTools/overview`
        : this._router.url;
...
@Injectable()
export class MetricsPerInstanceAppServicePlanResolver
  implements Resolve<Observable<boolean>>
{
  private resourceId: string;
  constructor(
...
@Injectable()
export class AdvanceApplicationRestartResolver
  implements Resolve<Observable<boolean>>
{
  private resourceId: string;
  constructor(
