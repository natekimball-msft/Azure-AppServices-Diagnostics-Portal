...
import {
  ...
  ArmResourceConfig,
  LiveChatConfig
} from '../models/arm/armResourceConfig';
...
export class GenericArmConfigService {
  ...
  constructor(
    ...
    @Optional() private _telemetryService?: PortalKustoTelemetryService
  ) {}
  ...
  public initArmConfig(resourceUri: string): Observable<ArmResourceConfig> {
    ...
    return forkJoin(override, config).pipe(
      catchError((err) => of(err)),
      map((configs) => {
        if (!(configs instanceof Array)) {
          console.log(
            `Error occurred while reading arm resource config. Details...`
          );
          console.log(configs);
        }
        ...
        try {
          if (
            (this.overrideConfig &&
              this.overrideConfig.homePageText &&
              this.overrideConfig.homePageText.title) ||
            (this.resourceConfig &&
              this.resourceConfig.homePageText &&
              this.resourceConfig.homePageText.title)
          ) {
            currConfig.homePageText.title = this.getValue(
              this.resourceConfig.homePageText.title,
              this.overrideConfig.homePageText.title
            );
          }
        ...
        try {
          if (
            (this.overrideConfig &&
              this.overrideConfig.homePageText &&
              this.overrideConfig.homePageText.description) ||
            (this.resourceConfig &&
              this.resourceConfig.homePageText &&
              this.resourceConfig.homePageText.description)
          ) {
            currConfig.homePageText.description = this.getValue(
              this.resourceConfig.homePageText.description,
              this.overrideConfig.homePageText.description
            );
          }
        ...
        try {
          if (
            (this.overrideConfig &&
              this.overrideConfig.homePageText &&
              this.overrideConfig.homePageText.searchBarPlaceHolder) ||
            (this.resourceConfig &&
              this.resourceConfig.homePageText &&
              this.resourceConfig.homePageText.searchBarPlaceHolder)
          ) {
            currConfig.homePageText.searchBarPlaceHolder = this.getValue(
              this.resourceConfig.homePageText.searchBarPlaceHolder,
              this.overrideConfig.homePageText.searchBarPlaceHolder
            );
          }
        ...
        try {
          if (
            this.getValue(
              this.resourceConfig.matchRegEx,
              this.overrideConfig.matchRegEx
            ) != null
          ) {
            currConfig.matchRegEx = this.getValue(
              this.resourceConfig.matchRegEx,
              this.overrideConfig.matchRegEx
            );
          }
        ...
        try {
          if (
            this.getValue(
              this.resourceConfig.searchSuffix,
              this.overrideConfig.searchSuffix
            ) != null
          ) {
            currConfig.searchSuffix = this.getValue(
              this.resourceConfig.searchSuffix,
              this.overrideConfig.searchSuffix
            );
          }
        ...
        try {
          if (
            this.getValue(
              this.resourceConfig.azureServiceName,
              this.overrideConfig.azureServiceName
            ) != null
          ) {
            currConfig.azureServiceName = this.getValue(
              this.resourceConfig.azureServiceName,
              this.overrideConfig.azureServiceName
            );
          }
        ...
        try {
          if (
            this.overrideConfig.armApiConfig &&
            !this.resourceConfig.armApiConfig
          ) {
            ...
            if (
              ...
              if (
                ...
                try {
                  if (
                    !!this.getValue(
                      this.resourceConfig.armApiConfig.armApiVersion,
                      this.overrideConfig.armApiConfig.armApiVersion
                    )
                  ) {
                    currArmApiConfig.armApiVersion = this.getValue(
                      this.resourceConfig.armApiConfig.armApiVersion,
                      this.overrideConfig.armApiConfig.armApiVersion
                    );
                  }
                ...
                try {
                  if (
                    !!this.getValue(
                      this.resourceConfig.armApiConfig
                        .isArmApiResponseBase64Encoded,
                      this.overrideConfig.armApiConfig
                        .isArmApiResponseBase64Encoded
                    )
                  ) {
                    currArmApiConfig.isArmApiResponseBase64Encoded =
                      this.getValue(
                        this.resourceConfig.armApiConfig
                          .isArmApiResponseBase64Encoded,
                        this.overrideConfig.armApiConfig
        ...
        try {
          if (
            this.getValue(
              this.resourceConfig.isSearchEnabled,
              this.overrideConfig.isSearchEnabled
            ) != null
          ) {
            currConfig.isSearchEnabled = this.getValue(
              this.resourceConfig.isSearchEnabled,
              this.overrideConfig.isSearchEnabled
            );
          }
        ...
        try {
          if (
            this.getValue(
              this.resourceConfig.pesId,
              this.overrideConfig.pesId
            ) != null
          ) {
            currConfig.pesId = this.getValue(
              this.resourceConfig.pesId,
              this.overrideConfig.pesId
            );
          }
        ...
        try {
          if (
            this.getValue(
              this.resourceConfig.sapProductId,
              this.overrideConfig.sapProductId
            ) != null
          ) {
            currConfig.sapProductId = this.getValue(
              this.resourceConfig.sapProductId,
              this.overrideConfig.sapProductId
            );
          }
        ...
        try {
          if (
            this.overrideConfig.liveChatConfig &&
            !this.resourceConfig.liveChatConfig
          ) {
            ...
            if (
              ...
              if (
                this.getValue(
                  this.resourceConfig.liveChatConfig.isApplicableForLiveChat,
                  this.overrideConfig.liveChatConfig.isApplicableForLiveChat
                )
              ) {
                currLiveChatConfig.isApplicableForLiveChat = this.getValue(
                  this.resourceConfig.liveChatConfig.isApplicableForLiveChat,
                  this.overrideConfig.liveChatConfig.isApplicableForLiveChat
                );
              }
              ...
              if (
                ...
                this.overrideConfig.liveChatConfig.supportTopicIds.length > 0 &&
                (!this.resourceConfig.liveChatConfig.supportTopicIds ||
                  (this.resourceConfig.liveChatConfig.supportTopicIds &&
                    this.resourceConfig.liveChatConfig.supportTopicIds.length <
                      1))
              ) {
                ...
                if (
                  ...
                  if (
                    this.overrideConfig.liveChatConfig.supportTopicIds &&
                    this.resourceConfig.liveChatConfig.supportTopicIds &&
                    this.overrideConfig.liveChatConfig.supportTopicIds.length >
                      0 &&
                    this.resourceConfig.liveChatConfig.supportTopicIds.length >
                      0
                  ) {
                    ...
                    currMergedSupportTopicIds =
                      this.overrideConfig.liveChatConfig.supportTopicIds.concat(
                        this.resourceConfig.liveChatConfig.supportTopicIds
                      );

                    //Make sure that we have distinct values after merging.
                    currMergedSupportTopicIds =
                      currMergedSupportTopicIds.filter(
                        this.distinctStringValues
                      );

                    if (
                      currMergedSupportTopicIds.findIndex(
                        (currEntry: string) => {
                          return currEntry === '*';
                        }
                      ) > -1
              ...
              if (
                ...
                this.overrideConfig.liveChatConfig.sapSupportTopicIds.length >
                  0 &&
                ...
                if (
                  this.resourceConfig.liveChatConfig.sapSupportTopicIds &&
                  this.resourceConfig.liveChatConfig.sapSupportTopicIds.length >
                    0 &&
                  (!this.overrideConfig.liveChatConfig.sapSupportTopicIds ||
                    (this.overrideConfig.liveChatConfig.sapSupportTopicIds &&
                      this.overrideConfig.liveChatConfig.sapSupportTopicIds
                  ...
                  if (
                    ...
                    //Support topics exist in both resourceConfig and overrideConfig, merge them
                    currMergedSapSupportTopicIds =
                      this.overrideConfig.liveChatConfig.sapSupportTopicIds.concat(
                        this.resourceConfig.liveChatConfig.sapSupportTopicIds
                      );

                    //Make sure that we have distinct values after merging.
                    currMergedSapSupportTopicIds =
                      currMergedSapSupportTopicIds.filter(
                        this.distinctStringValues
                      );

                    if (
                      currMergedSapSupportTopicIds.findIndex(
                        (currEntry: string) => {
                          return currEntry === '*';
                        }
                      ) > -1
              ...
              currLiveChatConfig.sapSupportTopicIds =
                currMergedSapSupportTopicIds;
        ...
        try {
          if (
            this.overrideConfig.categories &&
            !this.resourceConfig.categories
          ) {
            currConfig.categories = this.overrideConfig.categories.filter(
              (cat) => {
                return cat.id !== '';
              }
            );
            ...
            if (
              ...
              currConfig.categories = this.resourceConfig.categories.filter(
                (cat) => {
                  return cat.id !== '';
                }
              );
              ...
              this.resourceConfig.categories.forEach((currCat) => {
                ...
                if (categoryToCompare) {
                  ...
                  if (categoryToCompare.name || currCat.name) {
                    currMergedCategory.name = this.getValue(
                      currCat.name,
                      categoryToCompare.name
                    );
                  }

                  //currConfig.categories[x].description
                  if (categoryToCompare.description || currCat.description) {
                    currMergedCategory.description = this.getValue(
                      currCat.description,
                      categoryToCompare.description
                    );
                  }

                  //currConfig.categories[x].keywords
                  if (categoryToCompare.keywords || currCat.keywords) {
                    currMergedCategory.keywords = this.getValue(
                      currCat.keywords,
                      categoryToCompare.keywords
                    );
                  }

                  //currConfig.categories[x].color
                  if (categoryToCompare.color || currCat.color) {
                    currMergedCategory.color = this.getValue(
                      currCat.color,
                      categoryToCompare.color
                    );
                  }
                  ...
                  if (
                    this.getValue(
                      currCat.createFlowForCategory,
                      categoryToCompare.createFlowForCategory
                    ) != null
                  ) {
                    currMergedCategory.createFlowForCategory = this.getValue(
                      currCat.createFlowForCategory,
                      categoryToCompare.createFlowForCategory
                    );
                  }
                  ...
                  if (
                    this.getValue(
                      currCat.chatEnabled,
                      categoryToCompare.chatEnabled
                    ) != null
                  ) {
                    currMergedCategory.chatEnabled = this.getValue(
                      currCat.chatEnabled,
                      categoryToCompare.chatEnabled
                    );
                  }
                  ...
                  mergedCategories.forEach((mergedCat) => {
                    ...
                    if (!tempCat) {
                      ...
                      if (currCat.keywords && currCat.keywords.length > 0) {
                        ...
                        mergedArray = (
                          mergedCat.keywords.join(',') +
                          ',' +
                          currCat.keywords.join(',')
                        ).split(',');
                      ...
                      if (
                        this.getValue(
                          mergedCat.createFlowForCategory,
                          currCat.createFlowForCategory
                        ) != null
                      ) {
                        mergedCat.createFlowForCategory = this.getValue(
                          mergedCat.createFlowForCategory,
                          currCat.createFlowForCategory
                        );
                      }
                      ...
                      if (
                        this.getValue(
                          mergedCat.chatEnabled,
                          currCat.chatEnabled
                        ) != null
                      ) {
                        mergedCat.chatEnabled = this.getValue(
                          mergedCat.chatEnabled,
                          currCat.chatEnabled
                        );
                      }
        ...
        try {
          if (
            this.getValue(
              this.resourceConfig.quickLinks,
              this.overrideConfig.quickLinks
            ) != null
          ) {
            currConfig.quickLinks = this.getValue(
              this.resourceConfig.quickLinks,
              this.overrideConfig.quickLinks
            );
          }
        ...
        try {
          if (
            this.getValue(
              this.resourceConfig.keystoneDetectorId,
              this.overrideConfig.keystoneDetectorId
            ) != null
          ) {
            currConfig.keystoneDetectorId = this.getValue(
              this.resourceConfig.keystoneDetectorId,
              this.overrideConfig.keystoneDetectorId
            );
          }
        ...
        try {
          if (
            this.getValue(
              this.resourceConfig.riskAlertConfigs,
              this.overrideConfig.riskAlertConfigs
            ) != null
          ) {
            currConfig.riskAlertConfigs = this.getValue(
              this.resourceConfig.riskAlertConfigs,
              this.overrideConfig.riskAlertConfigs
            );
          }
        ...
        try {
          if (
            this.getValue(
              this.resourceConfig.notificationConfig,
              this.overrideConfig.notificationConfig
            ) != null
          ) {
            currConfig.notificationConfig = this.getValue(
              this.resourceConfig.notificationConfig,
              this.overrideConfig.notificationConfig
            );
          }
        ...
        try {
          if (
            this.getValue(
              this.resourceConfig.disableGenie,
              this.overrideConfig.disableGenie
            ) != null
          ) {
            currConfig.disableGenie = this.getValue(
              this.resourceConfig.disableGenie,
              this.overrideConfig.disableGenie
            );
          }
  ...
  getArmApiConfig(resourceUri: string): ArmApiConfig {
    if (
      this.getArmResourceConfig(resourceUri) &&
      !!this.getArmResourceConfig(resourceUri).armApiConfig
    ) {
  ...
  getApiVersion(resourceUri: string): string {
    let apiVersion = '';
    if (
      !!this.getArmApiConfig(resourceUri) &&
      !!this.getArmApiConfig(resourceUri).armApiVersion
    ) {
  ...
  isArmApiResponseBase64Encoded(resourceUri: string): boolean {
    if (
      !!this.getArmApiConfig(resourceUri) &&
      !!this.getArmApiConfig(resourceUri).isArmApiResponseBase64Encoded
    ) {
      return true;
    } else {
      return false;
