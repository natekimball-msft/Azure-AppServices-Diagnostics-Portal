...
export class UriElementsService {
  private _resourceProviderPrefix: string =
    '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.Web/';
  private _siteResource = this._resourceProviderPrefix + 'sites/{siteName}';
  private _hostingEnvironmentResource =
    this._resourceProviderPrefix + 'hostingEnvironments/{name}';
  private _slotResource = '/slots/{slot}';
  private _storageAccountsProviderPrefix: string =
    '/subscriptions/{subscriptionId}/providers/Microsoft.Storage';
  private _storageAccountResourceProviderPrefix: string =
    '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.Storage';
  ...
  private _createStorageAccountFormatUrl: string =
    '/storageAccounts/{accountName}';
  private _storageContainerFormatUrl: string =
  ...
  private _diagnosticCategoryFormat: string =
    this._siteResourceDiagnosticsPrefix + '/{diagnosticCategory}';

  private _analysisResource: string =
    this._diagnosticCategoryFormat + '/analyses';
  private _analysisResourceFormat: string =
    this._analysisResource + '/{analysisName}/execute';

  private _detectorsUrlFormat: string =
    this._diagnosticCategoryFormat + '/detectors';
  private _detectorResourceFormat: string =
    this._detectorsUrlFormat + '/{detectorName}/execute';

  private _diagnosticProperties: string =
    this._siteResourceDiagnosticsPrefix + '/properties';
  ...
  private _killw3wpUrlFormat: string =
    this._supportApi +
    'sites/{subscriptionId}/{resourceGroup}/{siteName}/killsiteprocess';
  ...
  private _daasCpuMonitoringSessionActivePath =
    this._daasCpuMonitoringPath + '/active';
  private _daasCpuMonitoringSessionActivePathDetails =
    this._daasCpuMonitoringPath + '/activesessiondetails';
  private _daasCpuMonitoringStopPath = this._daasCpuMonitoringPath + '/stop';
  private _daasCpuMonitoringSingleSessionPath =
    this._daasCpuMonitoringPath + '/{sessionId}';
  private _daasCpuMonitoringAnalyzeSessionPath =
    this._daasCpuMonitoringPath + '/analyze?sessionId={sessionId}';
  ...
  private _daasDiagServerSessionsPathForInstance =
    this._daasDiagServerSessionsPath + '?instance={instanceId}';
  private _daasDiagServerActiveSessionPath =
    this._daasDiagServerSessionsPath + '/active';
  private _daasDiagServerSingleSessionPath =
    this._daasDiagServerSessionsPath + '/{sessionId}';
  private _daasDiagServerSettingsPath =
    this._daasDiagServerSessionsPath + '/settings';
  private _daasDiagServerValidateStorageAccountPath =
    this._daasDiagServerSessionsPath + '/validatestorageaccount';
  ...
  getSessionsUrl(site: SiteDaasInfo, useDiagnosticServerForLinux: boolean) {
    if (useDiagnosticServerForLinux) {
      return (
        this._getSiteResourceUrl(
          site.subscriptionId,
          site.resourceGroupName,
          site.siteName,
          site.slot
        ) + this._daasDiagServerSessionsPath
      );
    }
    return (
      this._getSiteResourceUrl(
  ...
  getSessionUrl(
    ...
    if (useDiagServerForLinux) {
      return (
        ...
        this._daasDiagServerSingleSessionPath.replace('{sessionId}', sessionId)
      );
    }
    return (
      this._getSiteResourceUrl(
        ...
        site.siteName,
        site.slot
      ) + this._daasSingleSessionPath.replace('{sessionId}', sessionId)
    );
  }
  ...
  getSessionsForInstanceUrl(site: SiteDaasInfo, instanceId: string) {
    return (
      ...
      this._daasDiagServerSessionsPathForInstance.replace(
        '{instanceId}',
        instanceId
      )
    );
  ...
  getActiveSessionUrl(site: SiteDaasInfo) {
    return (
      this._getSiteResourceUrl(
        ...
        site.siteName,
        site.slot
      ) + this._daasActiveSessionPath
    );
  }

  getActiveSessionLinuxUrl(
    site: SiteDaasInfo,
    useDiagnosticServerForLinux: boolean
  ) {
    if (useDiagnosticServerForLinux) {
      return (
        this._getSiteResourceUrl(
          ...
          site.siteName,
          site.slot
        ) + this._daasDiagServerActiveSessionPath
      );
    }
    return (
      this._getSiteResourceUrl(
  ...
  getSingleSessionDeleteUrl(
    site: SiteDaasInfo,
    sessionId: string,
    isDiagServerSession: boolean
  ) {
  ...
  getNetworkTraceUrl(site: SiteInfoMetaData) {
    return (
      this._getSiteResourceUrl(
        ...
        site.siteName,
        site.slot
      ) + this._networkTraceStartPath
    );
  }

  getVirtualNetworkConnections(
    ...
    return (
      this._getSiteResourceUrl(
        ...
        siteName,
        slot
      ) + this._virtualNetworkConnections
    );
  }
  ...
  getActiveMonitoringSessionUrl(site: SiteDaasInfo) {
    return (
      this._getSiteResourceUrl(
        ...
        site.siteName,
        site.slot
      ) + this._daasCpuMonitoringSessionActivePath
    );
  }
  ...
  getActiveMonitoringSessionDetailsUrl(site: SiteDaasInfo) {
    return (
      this._getSiteResourceUrl(
        ...
        site.siteName,
        site.slot
      ) + this._daasCpuMonitoringSessionActivePathDetails
    );
  }
  stopMonitoringSessionUrl(site: SiteDaasInfo) {
    return (
      this._getSiteResourceUrl(
        ...
        site.siteName,
        site.slot
      ) + this._daasCpuMonitoringStopPath
    );
  }
  ...
  getMonitoringSessionUrl(site: SiteDaasInfo, sessionId: string) {
    return (
      ...
      this._daasCpuMonitoringSingleSessionPath.replace('{sessionId}', sessionId)
    );
  }
  ...
  getAnalyzeMonitoringSessionUrl(site: SiteDaasInfo, sessionId: string) {
    return (
      ...
      this._daasCpuMonitoringAnalyzeSessionPath.replace(
        '{sessionId}',
        sessionId
      )
    );
  ...
  getValidateStorageAccountUrl(site: SiteDaasInfo) {
    return (
      this._getSiteResourceUrl(
        ...
        site.siteName,
        site.slot
      ) + this._daasDiagServerValidateStorageAccountPath
    );
  }
  ...
  getLinuxDaasSettingsUrl(site: SiteDaasInfo) {
    return (
      this._getSiteResourceUrl(
        ...
        site.siteName,
        site.slot
      ) + this._daasDiagServerSettingsPath
    );
  }
  ...
  getSiteRestartUrl(
    ...
    return (
      this._getSiteResourceUrl(subscriptionId, resourceGroup, siteName, slot) +
      this._siteRestartUrlFormat
    );
  }
  ...
  getAnalysisResourceUrl(
    ...
    return (
      this._getSiteResourceUrl(subscriptionId, resourceGroup, siteName, slot) +
      this._analysisResourceFormat
        .replace('{diagnosticCategory}', diagnosticCategory)
  ...
  getDetectorsUrl(
    ...
    return (
      this._getSiteResourceUrl(subscriptionId, resourceGroup, siteName, slot) +
      this._detectorsUrlFormat.replace(
        '{diagnosticCategory}',
        diagnosticCategory
      )
    );
  ...
  getHostingEnvironmentAnalysisResourceUrl(
    subscriptionId: string,
    resourceGroup: string,
    name: string,
    diagnosticCategory: string,
    ...
    return (
      this._getHostingEnvironmentResourceUrl(
        subscriptionId,
        resourceGroup,
        name
      ) +
  ...
  getHostingEnvironmentDetectorsUrl(
    subscriptionId: string,
    resourceGroup: string,
    name: string,
    diagnosticCategory: string
  ...
  getHostingEnvironmentDetectorResourceUrl(
    subscriptionId: string,
    resourceGroup: string,
    name: string,
    diagnosticCategory: string,
  ...
  getDiagnosticPropertiesUrl(
    ...
    return (
      this._getSiteResourceUrl(subscriptionId, resourceGroup, siteName, slot) +
      this._diagnosticProperties
    );
  }

  getListAppSettingsUrl(
    subscriptionId: string,
    resourceGroup: string,
    siteName: string,
    slot: string = ''
    ...
    return (
      this._getSiteResourceUrl(subscriptionId, resourceGroup, siteName, slot) +
      this._listAppSettingsUrlFormat
    );
  }

  getUpdateAppSettingsUrl(
    subscriptionId: string,
    resourceGroup: string,
    siteName: string,
    slot: string = ''
    ...
    return (
      this._getSiteResourceUrl(subscriptionId, resourceGroup, siteName, slot) +
      this._updateAppSettingsUrlFormat
    );
  }
  ...
  getConfigWebUrl(site: SiteInfoMetaData): string {
    return (
      this._getSiteResourceUrl(
        ...
        site.siteName,
        site.slot
      ) + this._configWebUrlFormat
    );
  }

  getStorageAccountsUrl(subscriptionId: string): string {
    return (
      this._storageAccountsProviderPrefix.replace(
        '{subscriptionId}',
        subscriptionId
  ...
  createStorageAccountsUrl(
    subscriptionId: string,
    resourceGroup: string,
    accountName: string
  ): string {
    return (
      this._storageAccountResourceProviderPrefix
        .replace('{subscriptionId}', subscriptionId)
        .replace('{resourceGroup}', resourceGroup) +
      this._createStorageAccountFormatUrl.replace('{accountName}', accountName)
    );
  }
  ...
  getStorageContainerUrl(
    ...
    return (
      storageAccountId +
      this._storageContainerFormatUrl.replace('{containerName}', containerName)
    );
  }
  ...
  private _getSiteResourceUrl(
    subscriptionId: string,
    resourceGroup: string,
    siteName: string,
    slot: string = ''
  ) {
    let url = this._siteResource
      .replace('{subscriptionId}', subscriptionId)
      .replace('{resourceGroup}', resourceGroup)
  ...
  private _getHostingEnvironmentResourceUrl(
    subscriptionId: string,
    resourceGroup: string,
    name: string
  ) {
    return this._hostingEnvironmentResource
      .replace('{subscriptionId}', subscriptionId)
      .replace('{resourceGroup}', resourceGroup)
      .replace('{name}', name);
  }
