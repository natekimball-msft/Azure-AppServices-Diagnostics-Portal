...
export class SolutionFactoryService {
  ...
  getSolution(solution: ISolution): SolutionHolder {
    switch (solution.id) {
      case 1:
        return new SolutionHolder(SiteRestartComponent, <SolutionData>{
          title: 'Restart App',
          tags: [SolutionTypeTag.Mitigation],
          solution: solution
        });
      case 2:
        return new SolutionHolder(SiteRestartComponent, <SolutionData>{
      ...
      case 3:
        return new SolutionHolder(ScaleUpSolutionComponent, <SolutionData>{
          title: 'Scale Up App Service Plan',
          tags: [SolutionTypeTag.Mitigation],
          solution: solution
        });
      case 4:
        return new SolutionHolder(ScaleOutSolutionComponent, <SolutionData>{
          title: 'Scale Out App Service Plan',
          tags: [SolutionTypeTag.Mitigation],
          solution: solution
        });
      ...
      //     return null;
      case 12:
        return new SolutionHolder(
          SplitSitesIntoDifferentServerFarmsSolutionComponent,
          <SolutionData>{
            title: 'Split Apps Between ASPs',
            tags: [SolutionTypeTag.Mitigation],
            solution: solution
          }
        );
      ...
      case 17:
        return new SolutionHolder(RevertDeploymentComponent, <SolutionData>{
