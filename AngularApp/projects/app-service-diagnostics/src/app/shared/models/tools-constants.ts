...
export class ToolNames {
  ...
  public static JavaFlightRecorder: string =
  ...
  public static AppServicePlanMetrics: string =
...
export class ToolIds {
  ...
  public static EventViewer: string =
    SupportBladeDefinitions.EventViewer.Identifier;
  public static FrebViewer: string =
    SupportBladeDefinitions.FREBLogs.Identifier;
  public static MetricPerInstanceApp: string =
