...
export class RiskAlertsPanelComponent implements OnInit {
  ...
  ngOnInit() {
    this._riskAlertService.riskPanelContentsSub.subscribe(
      (risksPanelContents) => {
        ...
        this._riskAlertService.currentRiskPanelContentIdSub.subscribe(
          (currentRiskAlertDetectorId) => {
            this.riskPanelTitle =
              ...
              this._riskAlertService.riskAlertNotifications.hasOwnProperty(
                ...
                : this._riskAlertService.notificationMessageBar &&
                  this._riskAlertService.notificationMessageBar.panelTitle
                ? this._riskAlertService.notificationMessageBar.panelTitle
                : this.riskPanelTitle;
  ...
  logOpenLinkEvent(linkDescription: string, linkAddress: string) {
    this.telemetryService.logEvent('openRiskAlertLink', {
  ...
  openRiskAlertDetector(event: Event) {
    ...
    this.portalActionService.openBladeDiagnoseDetectorId(
      'RiskAssessments',
