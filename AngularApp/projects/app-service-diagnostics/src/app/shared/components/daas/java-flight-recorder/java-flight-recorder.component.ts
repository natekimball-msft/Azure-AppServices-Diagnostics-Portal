...
@Component({
  ...
  styleUrls: [
    './java-flight-recorder.component.scss',
    '../daas/daas.component.scss'
  ]
})
export class JavaFlightRecorderComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  initWizard(): void {
    ...
    this.WizardSteps.push({
      ...
      IconType: 'fa-user',
      AdditionalText:
        'Flight Recorder trace will stop automatically after 60 seconds',
