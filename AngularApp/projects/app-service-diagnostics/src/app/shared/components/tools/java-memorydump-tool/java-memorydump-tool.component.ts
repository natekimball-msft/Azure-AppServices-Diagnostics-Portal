...
export class JavaMemoryDumpToolComponent
  extends DaasBaseComponent
  implements OnInit
{
  title: string = 'Collect a Java Memory dump';
  description: string =
    'If your Java app is consuming lot of memory, you can collect a Java Memory dump to identify the types responsible for high memory consumption.';
