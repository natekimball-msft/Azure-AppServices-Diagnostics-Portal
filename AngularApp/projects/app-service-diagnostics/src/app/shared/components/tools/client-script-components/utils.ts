...
export class Utils {
  public static getAppServiceSiteObjectsAndServices(injector: Injector) {
    ...
    var fullSiteName =
      ...
      (siteMetaData.slot == '' ? '' : '-' + siteMetaData.slot);
    var siteInfo = {
      ...siteService.currentSiteMetaData.value,
      ...siteService.currentSite.value,
      fullSiteName
    };
    var diagProvider = new DiagProvider(
      siteInfo,
      armService,
      siteService,
      portalService.shellSrc,
      globals,
      telemetryService
    );
