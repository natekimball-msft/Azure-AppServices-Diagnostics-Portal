...
import { DataRenderBaseComponent, DynamicInsightV4Component, TelemetryService } from "diagnostic-data";
...
export class ComponentManager{
    ...
    constructor(){
        this.supportedComponentTypes = new Set<Type<any>>([DynamicInsightV4Component])
