...
export class JavaThreadDumpToolComponent
  extends DaasBaseComponent
  implements OnInit
{
  title: string = 'Collect a Java Thread dump';
  description: string =
    'If your Java app is performing slow or not responding at all, you can collect a jStack log to identify the state of threads running the java.exe';
